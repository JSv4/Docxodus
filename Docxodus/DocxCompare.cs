...
public static class DocxCompare
{
    ...
    /// natively), and <c>DetectFormatChanges</c> (DocxDiff uses
    /// <see cref="DocxDiffSettings.FormatComparison"/>, left at its default). DocxDiff-specific settings
    /// keep their defaults. An explicit
    ...
    internal static DocxDiffSettings ToDocxDiffSettings(WmlComparerSettings settings) => new()
    {
        ...
        CompareWhitespace = settings.CompareWhitespace,
