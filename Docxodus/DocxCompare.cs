...
public static class DocxCompare
{
    ...
    /// left at its default), and <c>CompareWhitespace</c> (a WmlComparer input-canonicalization pass;
    /// DocxDiff has no whitespace toggle yet). DocxDiff-specific settings keep their defaults. An explicit
