    ...
    public static partial class WmlToHtmlConverter
    {
        ...
        private static XElement ProcessChart(WordprocessingDocument wordDoc, XElement drawing)
        {
            ...
            var svg = new XElement(Svg + "svg",
                ...
                new XAttribute("data-docxodus-materialization", "chart"),
                new XAttribute("data-docxodus-materialization-state", "complete"),
                new XAttribute("data-docxodus-materialization-id", altText),
