...
namespace Docxodus
{
    ...
    public static class WmlComparer
    {
        ...
        public static WmlDocument Compare(WmlDocument source1, WmlDocument source2, WmlComparerSettings settings)
        {
            ...
            if (DocxCompare.CanReturnExactNoOp(source1, source2))
            ...
            bool preProcessMarkupInOriginal)
        {
            ...
            {
                source1 = Internal.WhitespaceCanonicalizer.Canonicalize(source1);
                source2 = Internal.WhitespaceCanonicalizer.Canonicalize(source2);
            }
  ...
  <w:r>
    ...
    <w:endnoteRef/>
            ...
            WmlComparerSettings settings, WmlComparerConsolidateSettings consolidateSettings)
        {
            ...
            if (!settings.CompareWhitespace)
                original = Internal.WhitespaceCanonicalizer.Canonicalize(original);
            ...
            using (MemoryStream consolidatedMs = new MemoryStream())
            {
                ...
                var newConsolidatedDocument = new WmlDocument(
                    "consolidated.docx",
                    ZipPackageOutputNormalizer.Normalize(consolidatedMs.ToArray()));
        ...
        private static WmlDocument ProduceDocumentWithTrackedRevisions(WmlComparerSettings settings, WmlDocument wmlResult, WordprocessingDocument wDoc1, WordprocessingDocument wDoc2)
        {
            ...
            using (MemoryStream ms = new MemoryStream())
            {
                ...
                foreach (var part in wDoc2.ContentParts())
                    part.PutXDocument();
                var updatedWmlResult = new WmlDocument(
                    "Dummy.docx",
                    ZipPackageOutputNormalizer.Normalize(ms.ToArray()));
