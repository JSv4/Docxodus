...
| Mean SSIM | 0.974586 | 0.978319 |
| Mean tolerant ink F1 | 0.394106 | 0.418563 |
...
4. **DrawingML textbox anchor geometry.** `DB011-Body-With-Shape.docx` now honors its
...
The former first priority (blank charts), the PR #372 rerun, aligned tab geometry, and DrawingML
textbox anchor geometry are resolved above. The remaining order is:

1. Correct inherited header/body/footer vertical placement independently of the now-fixed story
