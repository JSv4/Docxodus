...
<script type="module">
  import { createRibbonEditor } from 'https://cdn.jsdelivr.net/npm/docxodus@12.0.1/dist/embed.bundle.js';
...
<script type="module">
  import { createViewer, createEditor, createRibbonEditor }
    from 'https://cdn.jsdelivr.net/npm/docxodus@12.0.1/dist/embed.bundle.js';
...
```html
<div id="doc"></div>
<script src="https://cdn.jsdelivr.net/npm/docxodus@12.0.1/dist/embed.iife.js"></script>
<script>
...
- **Pin an exact version in production** (`docxodus@12.0.1`, not `@latest`) — CDN responses are
