...
const reportSchemaSource = resolve(packageRoot, '..', 'docs', 'schemas', 'render-report-v2.schema.json');
const reportSchemaDestination = join(dist, 'render-report-v2.schema.json');
