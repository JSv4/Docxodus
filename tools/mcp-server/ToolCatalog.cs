        ...
        new ToolDefinition(
            ...
            """
            {
              ...
              "properties": {
                ...
                "anchorId": { "type": "string", "description": "Optional for markdown/html/text/info and guard evaluation; required for formatting/spans; not accepted for manifest or semantic_changes, which always describe the complete document/package. Returned formatting/list/section anchors and span ranges can be passed unchanged to mutation tools." },
                "citation": {
