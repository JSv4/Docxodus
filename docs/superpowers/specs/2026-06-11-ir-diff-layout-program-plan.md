...
- **Gate criterion (per the standing USER DIRECTIVE) is now THE SCOREBOARD AT
  ...
  it to 100% by (a) closing the RUNNABLE_NOW failures (currently 128/178 = 71.9%
