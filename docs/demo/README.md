...
surface — `createRibbonEditor` from the pinned `docxodus@9.8.0` embed bundle on
...
1. Publish `docxodus@9.8.0` and confirm
   `https://cdn.jsdelivr.net/npm/docxodus@9.8.0/dist/embed.bundle.js` returns JavaScript.
